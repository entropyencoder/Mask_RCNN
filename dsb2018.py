...
class Dsb2018Dataset(utils.Dataset):
    ...
    # def load_dsb2018(self, dataset_dir, width, height):
    def load_dsb2018(self, dataset_dir, train_val):
        # train_path = '/home/yschoi/work/challenges/Kaggle_Data_Science_Bowl_2018/input/stage1_train/'
        # test_path = '/home/yschoi/work/challenges/Kaggle_Data_Science_Bowl_2018/input/stage1_test/'
...
def evaluate_dsb2018(model, dataset, coco, eval_type="bbox", limit=0, image_ids=None):
    """Runs official COCO evaluation.
    dataset: A Dataset object with valiadtion data
    eval_type: "bbox" or "segm" for bounding box or segmentation evaluation
    limit: if not 0, it's the number of images to use for evaluation
    ...
    for i, image_id in enumerate(image_ids):
        ...
        # # Convert results to COCO format
        # image_results = build_dsb2018_results(dataset, dsb2018_image_ids[i:i + 1],
        #                                    r["rois"], r["class_ids"],
        #                                    r["scores"], r["masks"])
        # results.extend(image_results)
...
if __name__ == '__main__':
    ...
    if args.command == "train":
        ...
        coco = dataset_test.load_dsb2018(TEST_PATH, "test")
        dataset_test.prepare()
        print("Running DSB-2018 evaluation on {} images.".format(args.limit))
        # with tf.device('/device:CPU:0'):
        #     evaluate_dsb2018(model, dataset_test, coco, "bbox", limit=int(args.limit))
        evaluate_dsb2018(model, dataset_test, coco, "bbox", limit=int(args.limit))
        ...
        # with tf.device('/device:CPU:0'):
        #     evaluate_dsb2018(model, dataset_test, coco, "bbox", limit=int(args.limit))
        pred_results = evaluate_dsb2018(model, dataset_test, coco, "bbox")
