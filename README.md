# Mask R-CNN customization for Data Science Bowl 2018 
- The base code and the following README are from [Matterport3D's Mask R-CNN implementation](https://github.com/matterport/Mask_RCNN).
